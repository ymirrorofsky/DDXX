angular.module('starter.controllers', [])
	...
	.controller('homeCtrl', function($rootScope, $scope, $ionicSlideBoxDelegate, $ionicLoading, $ionicModal, $state, $http, Home, Message, $location, $anchorScroll, $ionicScrollDelegate, Lbs, $ionicPopup, Storage, $cordovaGeolocation, $cordovaInAppBrowser) {
		...
		// 定位		
		var geolocationOption = { timeout: 5000, maximumAge: 10000, enableHighAccuracy: false }; //定位插件参数
...
//			Message.loading("定位中……");
	...
	.controller('userCenterCtrl', function($scope, $ionicActionSheet, $ionicLoading, $ionicHistory, $timeout, $state, User, $ionicModal) {
		// 退出登录
